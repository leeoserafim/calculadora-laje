...
def vigas_visual_h8():
    ...
    if reforco_cinco_vg != 0:
        ...
        reforco_cincoh8.append(ml_cinco) #adiciona esse metro linear de reforço na lista do reforço
    ...
    if reforco_seis_vg != 0:
        ...
        reforco_seish8.append(ml_seis)
        seis_mm_entry.delete(0,END)
        seis_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_seish8.append(0)
    ...
    if reforco_oito_vg != 0:
        ...
        reforco_oitoh8.append(ml_oito)
        oito_mm_entry.delete(0,END)
        oito_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_oitoh8.append(0)
    ...
    if reforco_dez_vg != 0:
        ...
        reforco_dezh8.append(ml_dez)
        dez_mm_entry.delete(0,END)
        dez_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_dezh8.append(0)
    ...
    if reforco_doze_vg != 0:
        ...
        reforco_dozeh8.append(ml_doze)
        doze_mm_entry.delete(0,END)
        doze_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_dozeh8.append(0)
    ...
    if reforco_dezesseis_vg != 0:
        ...
        reforco_dezesseish8.append(ml_dezesseis)
        dezesseis_mm_entry.delete(0,END)
        dezesseis_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_dezesseish8.append(0)
...
def vigas_visual_h12():
    ...
    if reforco_cinco_vg != 0:
        ...
        ml_cinco=(q_vg*tamanho_vg)*reforco_cinco_vg #faz a conta do metro linear do reforço(quantidade de barras adicionadas na entry vezes metro linear viga(quantidade X tamanho)
        reforco_cincoh12.append(ml_cinco) #adiciona esse metro linear de reforço na lista do reforço
        cinco_mm_entry.delete(0,END) #reseta entry para 0
        cinco_mm_entry.insert(0,'0') #reseta entry para 0
        varvg.set(0) #desmarca o checkbox
    else :
        reforco_cincoh12.append(0)
    ...
    if reforco_seis_vg != 0:
        ...
        ml_seis=(q_vg*tamanho_vg)*reforco_seis_vg
        reforco_seish12.append(ml_seis)
        seis_mm_entry.delete(0,END)
        seis_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_seish12.append(0)
    ...
    if reforco_oito_vg != 0:
        ...
        ml_oito=(q_vg*tamanho_vg)*reforco_oito_vg
        reforco_oitoh12.append(ml_oito)
        oito_mm_entry.delete(0,END)
        oito_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_oitoh12.append(0)
    ...
    if reforco_dez_vg != 0:
        ...
        ml_dez=(q_vg*tamanho_vg)*reforco_dez_vg
        reforco_dezh12.append(ml_dez)
        dez_mm_entry.delete(0,END)
        dez_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_dezh12.append(0)
    ...
    if reforco_doze_vg != 0:
        ...
        ml_doze=(q_vg*tamanho_vg)*reforco_doze_vg
        reforco_dozeh12.append(ml_doze)
        doze_mm_entry.delete(0,END)
        doze_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_dozeh12.append(0)
    ...
    if reforco_dezesseis_vg != 0:
        ...
        ml_dezesseis=(q_vg*tamanho_vg)*reforco_dezesseis_vg
        reforco_dezesseish12.append(ml_dezesseis)
        dezesseis_mm_entry.delete(0,END)
        dezesseis_mm_entry.insert(0,'0')
        varvg.set(0)
    else :
        reforco_dezesseish12.append(0)
...
def calcular():
    ...
    r_cinco=sum(reforco_cincoh8)+sum(reforco_cincoh12)
    r_seis=sum(reforco_seish8)+sum(reforco_seish12)
    r_oito=sum(reforco_oitoh8)+sum(reforco_oitoh12)
    r_dez=sum(reforco_dezh8)+sum(reforco_dezh12)
    r_doze=sum(reforco_dozeh8)+sum(reforco_dozeh12)
    r_dezesseis=sum(reforco_dezesseish8)+sum(reforco_dezesseish12)
...
def apagar_ultimo_h8():
    ...
    reforco_cincoh8.pop(apagar[0])
    reforco_seish8.pop(apagar[0])
    reforco_oitoh8.pop(apagar[0])
    reforco_dezh8.pop(apagar[0])
    reforco_dozeh8.pop(apagar[0])
    reforco_dezesseish8.pop(apagar[0])
...
def apagar_ultimo_h12():
    ...
    reforco_cincoh12.pop(apagar_h12[0])
    reforco_seish12.pop(apagar_h12[0])
    reforco_oitoh12.pop(apagar_h12[0])
    reforco_dezh12.pop(apagar_h12[0])
    reforco_dozeh12.pop(apagar_h12[0])
    reforco_dezesseish12.pop(apagar_h12[0])
...
def salvar():
    ...
    lista={'quantidadeh8':quantidade_h8,
                ...
                '5mmh8' : reforco_cincoh8,
                '6mmh8': reforco_seish8,
                '8mmh8': reforco_oitoh8,
                '10mmh8':reforco_dezh8,
                '12,5mmh8' : reforco_dozeh8,
                '16mmh8': reforco_dezesseish8,
                'reloadh8': reload_h8,
                'quantidadeh12':quantidade_h12,
                'reloadh12': reload_h12,
                'area_h12': area_h12,
                '5mmh12' : reforco_cincoh12,
                '6mmh12': reforco_seish12,
                '8mmh12': reforco_oitoh12,
                '10mmh12':reforco_dezh12,
                '12,5mmh12' : reforco_dozeh12,
                '16mmh12': reforco_dezesseish12,
            }
...
def recarregar():
    ...
    reforco_cincoh8.clear()
    reforco_seish8.clear()
    reforco_oitoh8.clear()
    reforco_dezh8.clear()
    reforco_dozeh8.clear()
    reforco_dezesseish8.clear()
    reload_h8.clear()
    ...
    reloadsh8up= [values for values in reloadsh8 if values != "0"]
    for fh8 in reloadsh8up:
        lista_vigas_h8.insert('end',fh8)

    reloadsh12=pandas['reloadh12'].values.tolist()
    reloadsh12up= [values for values in reloadsh12 if values != "0"]
    print(reloadsh12up)
    for fh12 in reloadsh12up:
        lista_vigas_h12.insert('end',fh12)
    

OUTPUT_PATH = Path(__file__).parent
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\PC\Desktop\Calculadora")
